...
var endCondition = false; //end condition switches to true if either the player runs out of health, the enemy runs out of health, or if the player runs away
var playerRoll = 0;
var playerDecision = true; //true means the player is going to attack, false means the player is running away. The GUI will need to pass whatever the user inputs to here.
var eneRoll = 0;
var playerHits = false;
var enemyHits = false;
